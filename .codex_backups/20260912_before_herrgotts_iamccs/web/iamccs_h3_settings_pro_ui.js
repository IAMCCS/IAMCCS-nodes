...
const MODE_CHOICES = [
  ...
  ["MASKED LOOP GUIDED", "longvid_masked_loop_guided", "Experimental: one full AV latent, in-place masked windows and absolute Shotboard image guides; no outer join or crossfade."],
