...
class IAMCCS_MiniMaxH3ShotPlanner:
    ...
    def plan(
        ...
        if longvid_lipsync_active:
            ...
            timeline_audio_contract = "Masked Loop Guided: one full AV latent is sampled through in-place overlapping windows; Shotboard images stay on absolute frame indices and no decoded segment join is created"
        elif longvid_active:
