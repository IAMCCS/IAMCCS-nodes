...
def _variant_active(cine_linx: Any) -> bool:
    ...
    if task_mode == "longvid_motion_context" and not motion_context_enabled:
        raise RuntimeError(
            "IAMCCS Long Multi-Shot Motion Context contract is missing or disabled. "
    ...
    if motion_context_enabled and declared_variant not in ("", "motion_context_auto_chain_v1"):
        raise RuntimeError(
            "IAMCCS Long Multi-Shot Motion Context contract conflicts with backend_variant="
