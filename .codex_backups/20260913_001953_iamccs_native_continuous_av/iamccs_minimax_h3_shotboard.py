...
class IAMCCS_MiniMaxH3ShotPlanner:
    ...
    def plan(
        ...
        longvid_requested = requested_task_key in {"longvid_guides", "longvid", "long_video_guides"} or longvid_lipsync_requested or motion_context_requested or masked_loop_requested
        ...
        elif str(plan.get("task_mode", "")).lower() == "longvid_masked_loop_guided":
            timeline_audio_contract = (
                "Herrgotts Direct AV: every chronological Shotboard image is an FL2VA destination; "
                "the complete generated video+audio latent passes into the next interval, automatic "
                "freeze-tail analysis selects the phase-aligned handover, and the v1.2 safe-tail join owns the seam"
            )
        elif longvid_active:
